...
时间工具 SHALL provide a standard 5-field Cron expression helper that validates the expression, explains it in readable text, and previews the next 5 run times using the local system time zone.
