...
数据工具 SHALL provide a CSV sub-tool alongside JSON, YAML, SQL, and XML sub-tools for CSV to JSON conversion, JSON to CSV conversion, and read-only table preview.
